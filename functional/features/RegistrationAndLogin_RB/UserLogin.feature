Feature: As a registered user I want to log in to the website
  ...
  Scenario: User logout and login as another user (cache validation)
    Given I am logged in to frontend as "kkatekoss@gmail.com" with password "123123qa!"
    Then I should see "kkatekoss@gmail.com"
    And I should see "My Dashboard"
    And I wait for 10 seconds
    Then I click on "//a[contains(@class, 'user action toggle') and text() = 'My Account']"
    And I wait for 10 seconds
    ...
    And I am logged in to frontend as "kkatekoss1@gmail.com" with password "123123qa!"
